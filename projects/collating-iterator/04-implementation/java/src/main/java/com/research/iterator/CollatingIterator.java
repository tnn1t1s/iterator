...
/**
 * CollatingIterator merges k sorted iterators into a single sorted iterator
 * using a loser tournament tree.
 *
 * <p>This implementation achieves O(N log k) time complexity and O(k) space
 * complexity, where N is the total number of elements and k is the number
 * of input iterators.
 *
 * <p>Based on:
 ...
 */
public class CollatingIterator<T extends Comparable<? super T>> implements Iterator<T> {
    ...
    /**
     * Constructs a CollatingIterator from multiple sorted iterators.
     *
